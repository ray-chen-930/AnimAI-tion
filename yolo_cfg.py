...
# Set the class name
__C.YOLO.CLASSES                = "./data/dataset/boy_classes.txt"
...
__C.TRAIN.ANNOT_PATH            = "./data/boy3.txt"
...
__C.TRAIN.CHECKPOINTS_TO_KEEP   = 30
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/yolov3_coco_demo.ckpt"
__C.TRAIN.CHECKPOINT_PREFIX     = "boy3_new"
...
__C.TEST.ANNOT_PATH             = "./data/boy3_test.txt"
